...
export const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  supabase: 'Configure Supabase integration',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'supabase', visible: true, window: 'user' as const, order: 2 },
  ...
  { id: 'supabase', visible: true, window: 'developer' as const, order: 2 },
